...
export const ExpenseForm = ({setSeed}: ExpensesFormContainerProps) => {
    ...
    return (
    <form className={"container w-full flex-auto"} onSubmit={handleSubmit}>
        <div className={"flex flex-row mt-5 w-full p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 gap-8"}>
            <div className={"w-full relative"}>
                ...
                <input type="text" name="concept" id="concept" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Bottle of Water" required></input>
                <p className="text-red-500 text-xs italic">{errors["concept"]}</p>
            </div>
            <div className={"w-full relative"}>
                <label htmlFor="amount" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Amount</label>
                <input type="number" name="amount" step="0.01" id="amount" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="1.80" required></input>
                <p className="text-red-500 text-xs italic">{errors["amount"]}</p>
            </div>

            <div className={"flex flex-col justify-between p-3"}>
                <div className="flex items-center">
                    <input id="income" name="income" type="checkbox" value="" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"></input>
                    <label htmlFor="income" className="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Income</label>
                </div>
                <div className="flex items-center">
                    <input id="monthly" name="monthly" type="checkbox" value="" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"></input>
            ...
            <button type={"submit"} className={"flex h-20 items-center p-4 cursor-pointer"}>
